...
<p>
  <img src="https://skillicons.dev/icons?i=java,python,spring,aws,kafka,docker,mysql,redis,git&theme=dark" />
</p>
...
- designed the architecture for an async messaging hub using kafka + fine-tuned LLMs — placed top 3 at a hackathon
- prototyped an AI orchestration layer in python + langchain to automate airline rebooking during flight disruptions
- optimized CI/CD pipelines and fixed thread-safety issues to hit 99.9% uptime at scale
